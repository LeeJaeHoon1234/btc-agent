...
class BTCAgentOrchestrator:
    ...
    def run(self, market_df=None) -> AgentState:
        state = AgentState()
        ...
        # 5) Confidence Gate / Conditional Routing
        ...
        # 8) Critic -> Revision Feedback Loop
        if state.gate.route == "deep_analysis":
        ...
        # 10) Explanation Agent — 최종 판단을 쉬운 문장으로 번역
