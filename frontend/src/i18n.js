...
export const I18N = {
  ...
  en: {
    ...
    agentCouncil: 'Agent Council', agentCouncilTitle: 'Independent specialist views', disagreement: 'Disagreement', counterpoint: 'Counterpoint', councilNames: { technical: 'Technical', derivatives: 'Derivatives', onchain_flow: 'On-chain & flows', macro_news: 'Macro & news', historical: 'Historical analogs', risk: 'Risk' },
